...
//     if(!FontSetSize(OsKernelData->StartupFont.Font, FontSize) || !FontSetWeight(OsKernelData->StartupFont.Font, FontWeight)) {
...
//         if (!FontRenderGlyf(OsKernelData->StartupFont.Font, &GlyphData, Text[i], PrevChar)) {
//             continue;
